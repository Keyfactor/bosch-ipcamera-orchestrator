...
* **Create BIPCamera manually in the Command UI**:
    ...
    | ---- | ------------ | ---- | --------------------- | -------- | ----------- |
    | ServerUsername | Server Username |  | Secret |  | 🔲 Unchecked |
    | ServerPassword | Server Password |  | Secret |  | 🔲 Unchecked |
    | ServerUseSsl | Use SSL |  | Bool | true | ✅ Checked |
    ...
    | ---- | ------------ | ---- | ------------- | ----------------------- | ---------------- | ----------------- | ------------------- | ----------- |
    | CertificateUsage | Certificate Usage |  | MultipleChoice |  | 🔲 Unchecked | 🔲 Unchecked | 🔲 Unchecked | 🔲 Unchecked |
    | Name | Name (Alias) |  | String |  | 🔲 Unchecked | 🔲 Unchecked | 🔲 Unchecked | ✅ Checked |
    | Overwrite | Overwrite |  | Bool | false | 🔲 Unchecked | 🔲 Unchecked | 🔲 Unchecked | 🔲 Unchecked |
