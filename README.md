...
For more information on [kfutil](https://github.com/Keyfactor/kfutil) check out the [docs](https://github.com/Keyfactor/kfutil?tab=readme-ov-file#quickstart)
   <details><summary>Click to expand BIPCamera kfutil details</summary>
...
#### Manual Creation
Below are instructions on how to create the BIPCamera store type manually in
the Keyfactor Command Portal
   <details><summary>Click to expand manual BIPCamera details</summary>
